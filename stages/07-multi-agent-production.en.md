...
| [**ClawBench**](https://github.com/TIGER-AI-Lab/ClawBench) | browser-agent tasks on real websites | **44.6%** (lenient)/**24.6%** (strict) | Claude Opus 4.7 (V2 Hermes leaderboard, 58/130 passed); 283 tasks, 144 real websites, Apache-2.0, [paper](https://arxiv.org/abs/2604.08523); V2's two-stage rubric is stricter than V1 |

...
| [**ClawBench**](https://github.com/TIGER-AI-Lab/ClawBench) | 真實網站上的 browser agent 任務 | **44.6%**（lenient）/**24.6%**（strict） | Claude Opus 4.7（V2 Hermes leaderboard、58/130 通過）；283 個任務、144 個真實網站、Apache-2.0、[論文](https://arxiv.org/abs/2604.08523)；V2 兩階段 rubric 較 V1 嚴格 |

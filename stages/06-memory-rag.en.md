...
| **Local-first AI memory / knowledge base**<br>(personal context / agent memory) | [Remio](https://remio.ai/) | ⭐⭐⭐⭐ | People who want CLI agents / desktop agents to use their personal knowledge base | Local-first AI memory / knowledge base desktop app. It parses notes, files, webpages, recordings, emails, messages, images, and other sources, then builds local indexes and vectors so agents retrieve precise context instead of repeatedly grepping directories, scanning files, or loading whole documents into prompts. |

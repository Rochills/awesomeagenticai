...
| | [LightAgent](https://github.com/wanxingai/LightAgent) | ⭐⭐⭐ | Developers who want a lightweight Python agent framework for tool use, memory, MCP/SSE, and multi-agent collaboration. | Small API surface with OpenAI-compatible streaming, Tree-of-Thought planning, reusable Skills, and LightSwarm; useful for prototypes, teaching, and readable-core agent apps. |

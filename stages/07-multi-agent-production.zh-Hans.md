...
| [**ClawBench**](https://github.com/TIGER-AI-Lab/ClawBench) | 真实网站上的 browser agent 任务 | **44.6%**（lenient）/**24.6%**（strict） | Claude Opus 4.7（V2 Hermes leaderboard、58/130 通过）；283 个任务、144 个真实网站、Apache-2.0、[论文](https://arxiv.org/abs/2604.08523)；V2 两阶段 rubric 比 V1 更严格 |

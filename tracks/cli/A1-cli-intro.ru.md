...
- Знать разницу между основными CLI agents (Claude Code / Codex / OpenCode / Gemini CLI / goose / Aider / Hermes Agent)
...
Намеренно измени API-ключ (замени любой символ) и посмотри, как CLI выдаст ошибку. Потом «правильный ключ, но неверное имя модели». В продакшене auth-проблемы неизбежны — наступи на них сейчас.

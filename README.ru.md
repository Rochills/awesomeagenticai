...
Мы собрали **134 качественных проекта** в карту обучения «с нуля до продвинутых multi-agent», разбитую на **7 этапов**. Каждый этап чётко говорит, **что учить, какие упражнения делать, какие проекты изучать и какую самопроверку пройти перед следующим этапом**.
...
| Этап | Тема | Ключевой контент | Время |
|---|---|---|---|
| **A1** | [CLI Agent: введение и выбор](tracks/cli/A1-cli-intro.ru.md) | сравнение 6 CLI · установка · первый запуск | 1 нед |
